<section class="bg-[#050e1a] p-6 rounded-lg shadow-md">
    <header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="staff_number" name="staff_number" type="text"
                class="mt-1 block w-full bg-gray-100 text-gray-700" :value="old('staff_number', $user->staff_number)" readonly />
        ...
        <div>
            ...
            <x-text-input id="student_number" name="student_number" type="text"
                class="mt-1 block w-full bg-gray-100 text-gray-700" :value="old('student_number', $user->student_number)" readonly />
        ...
        <div>
            ...
            <x-text-input id="position" name="position" type="text"
                class="mt-1 block w-full bg-gray-100 text-gray-700" :value="old('position', $user->position)" readonly />
        ...
        <div>
            ...
            <x-text-input id="role" name="role" type="text"
                class="mt-1 block w-full bg-gray-100 text-gray-700" :value="$user->role" readonly />
        </div>
